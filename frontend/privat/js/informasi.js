...
document.querySelectorAll('.btnCancelDelete').forEach(btn => {
  btn.addEventListener('click', () => {
    Swal.fire({
      title: "Yakin hapus?",
      text: "Data Informasi akan dihapus permanen!",
      icon: "warning",
...
document.querySelectorAll('.btnSimpan').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    const jamPelayanan = document.getElementById('jamPelayanan').value.trim();
    const jamIstirahat = document.getElementById('jamIstirahat').value.trim();

    let kosong = [];

    if (!hari) kosong.push("Hari");
    if (!jamPelayanan) kosong.push("Jam Pelayanan");
    if (!jamIstirahat) kosong.push("Jam Istirahat");
    ...
    Swal.fire({
      ...
      icon: "question",
      html: `
        <p><b>Hari:</b><br>${hari}</p>
        <p><b>Jam Pelayanan:</b><br>${jamPelayanan}</p>
        <p><b>Jam Istirahat:</b><br>${jamIstirahat}</p>
      `,
      showCancelButton: true,
